...
namespace AcademyManagement.Infrastructure.MappingProfile
{
    public class UserMappingProfile:Profile
    {
        public UserMappingProfile()
        {
            ...
            CreateMap<EditUserDTO,User>().ForMember(p => p.Avatar, d => d.Ignore()).ForMember(u => u.PasswordHash, u => u.Condition(u => u.Password != null)).ForMember(u=>u.InsertTime,u=>u.Ignore());
        }
    }
}
